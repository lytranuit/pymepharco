    ...
    <div id="headerContent">
        ...
        <div id="headerSearch">
            <form class="search  flex  align-center" action="/product/search" method="get">
                <input class="search__input  f6  fw4  ph4  mr3  bg-white  ba  bc-light-silver  br-pill" type="search" name="q" placeholder="<?= lang("Custom.search_text") ?>" style="min-width: 300px; min-height: 50px;outline: none;border-radius: 100px;padding: 0px 30px;vertical-align: middle;display: inline-block;border: 1px solid gray;">
