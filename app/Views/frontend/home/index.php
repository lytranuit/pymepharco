    ...
    <div id="content" role="main">
        ...
        <section class="section has-parallax" id="section_1938914310">
            ...
            <style scope="scope">
                ...
                #section_1938914310 .section-bg-overlay {
        ...
        <section class="section" id="section_416297056">
            <div class="container">
                ...
                <div class="row align-middle" id="row-2040554183">
                    <div class="col medium-3 small-12 large-3" data-animate="fadeInLeft">
                        <div class="col-inner">
                            <div class="row" id="row-434758725">
                                <div class="col small-12 large-12">
                                    <div class="col-inner text-right">

                                        <div class="icon-box featured-box boxxx icon-box-top text-left">
                                            <div class="icon-box-img" style="width: 60px">
                                                <div class="icon">
                                                    <div class="icon-inner" style="color:rgb(86, 182, 101);">
                                                        <!--?xml version="1.0"?-->
                                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 299.429 299.429" style="enable-background:new 0 0 299.429 299.429;" xml:space="preserve" width="512px" height="512px" class="">
                                                            <g>
                                                                <g>
                                        ...
                                        <div class="icon-box featured-box boxxx icon-box-top text-left">
                                            <div class="icon-box-img" style="width: 60px">
                                                <div class="icon">
                                                    <div class="icon-inner" style="color:rgb(86, 182, 101);">
                                                        <!--?xml version="1.0"?-->
                                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 58.365 58.365" style="enable-background:new 0 0 58.365 58.365;" xml:space="preserve" width="512px" height="512px" class="">
                                                            <g>
                    ...
                    <div class="col chose-col-img medium-6 small-12 large-6" data-animate="bounceIn">
                        <div class="col-inner">
                    ...
                    <div class="col medium-3 small-12 large-3" data-animate="fadeInRight">
                        <div class="col-inner">
                            <div class="row" id="row-1013238488">
                                <div class="col chose-colr small-12 large-12">
                                    <div class="col-inner text-left">

                                        <div class="icon-box featured-box boxxxx icon-box-top text-left">
                                            <div class="icon-box-img" style="width: 60px">
                                                <div class="icon">
                                                    <div class="icon-inner" style="color:rgb(86, 182, 101);">
                                                        <!--?xml version="1.0"?-->
