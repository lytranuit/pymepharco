    ...
    <div id="pageImageOverlay">
        ...
        <div class="pageTitle" style="opacity: 1; top: 50%; bottom: auto; transform: translateY(-50%);">
            <div class="pageTitleContent">
                <div><span id="pageImageInstance_lblTitle">Quality Policy</span></div>
            </div>
        </div>
    </div>
    ...
    <div class="row g-0">
        <div class="col-12">
            <h2 style="text-align: center;">
                CERTIFICATE OF PYMEPHARCO EU-GMP EU-GMP
            </h2>
            <img src="/assets/images/policy/Pages-1-from_GMP_Certificate_RPD_Pymepharco.jpg" style="width:100%" />
            <div style="text-align: center;">
                <a href="/assets/images/policy/GMP_Certificate_RPD_Pymepharco.pdf" style="font-size:20px;font-weight:bold;">Read more</a>
            </div>
        </div>
        <div class="col-12">
            <h2 style="text-align: center;">
                QUALITY POLICY PYMEPHARCO COMMITMENT
            </h2>
