                                    ...
                                    <div class="card card--banner flex flex-column h-100">
                                        <a class="link" href="<?= url_product($row) ?>" title="<?= $row->{pick_language($row, 'name_')} ?>">
                                            <figure class="card-image border-grey ph3 pv3 flex align-center" style="height:360px">
                                                <img class="w-100" data-src="<?= base_url(isset($row->image->src) ? $row->image->src : "assets/images/placeholder.png") ?>" alt="<?= $row->{pick_language($row, 'name_')} ?>" title="<?= $row->{pick_language($row, 'name_')} ?>" src="<?= base_url(isset($row->image->src) ? $row->image->src : "assets/images/placeholder.png") ?>">
                                            </figure>
