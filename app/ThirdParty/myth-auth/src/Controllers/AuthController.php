...
class AuthController extends Controller
{
	...
	public function login()
	{
		...
		$_SESSION['redirect_url'] = $next ?? previous_url() ?? site_url('/admin');
		// print($_SESSION['redirect_url']);
	...
	public function attemptRegister()
	{
		...
		$rules = [
			'username'  	=> 'required|alpha_numeric_space|min_length[3]|is_unique[pet_auth_users.username]',
			'email'			=> 'required|valid_email|is_unique[pet_auth_users.email]',
